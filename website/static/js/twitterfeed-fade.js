...
$(document).ready(function () {
    var displaylimit = 10;
    var twitterprofile = "united";
	var screenname = "United Airlines";
	...
	var headerHTML = '';
	var loadingHTML = '';
	headerHTML += '<div id="twitter-header"><a href="https://twitter.com/" target="_blank"><img src="../static/images/twitter-bird-light.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
    ...
    $.getJSON('../static/js/get_tweets.php', 
        function(feeds) {   
		   //alert(feeds);
            var feedHTML = '';
				...
				//console.log(feeds[i]);
				 ...
				 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
					if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
						...
						feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" target="_blank"><img src="'+profileimage+'"../static/images/twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
